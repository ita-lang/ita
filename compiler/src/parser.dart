/// Parser da linguagem Glu.
///
/// Recursive descent com Pratt parsing para expressões.
/// Consome tokens do Lexer e produz uma AST tipada.
...
class Parser {
  ...
  OperatorDecl _operatorDecl() {
    ...
    if (_match(TokenType.kwPrecedence)) {
      ...
      if (_match(TokenType.kwRight)) {
        rightAssoc = true;
      } else if (_match(TokenType.kwLeft)) {
        rightAssoc = false;
      }
    }
  ...
  ParseError _error(String message) {
    final token = _peek();
